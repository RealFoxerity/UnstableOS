#ifndef _UNSTABLEOS_ELF_H
#define _UNSTABLEOS_ELF_H
...
enum dynamic_entry_types {
    ...
    DT_HASH,
    DT_STRTAB,
    DT_SYMTAB,  // supported by loadelf's relocation
    DT_RELA,    // supported by loadelf's relocation
    DT_RELASZ,  // supported by loadelf's relocation
    DT_RELAENT, // supported by loadelf's relocation
    DT_STRSZ,
    DT_SYMENT,  // supported by loadelf's relocation
    DT_INIT,
    DT_FINI,
    DT_SONAME,
    DT_RPATH,
    DT_SYMBOLIC,
    DT_REL,     // supported by loadelf's relocation
    DT_RELSZ,   // supported by loadelf's relocation
    DT_RELENT,  // supported by loadelf's relocation
    DT_PLTREL,
    DT_DEBUG,
    DT_TEXTREL,
    DT_JMPREL,
